...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">权限组管理</a><a href="#" class="current">权限组总览</a> </div>
        <h1 style="float:left">用户组总览</h1>
    </div>
                        ...
                        <div class="over"  >
                            <table class="table table-bordered data-table" style="overflow:hidden">
                                ...
                                <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr class="gradeX">
                                        ...
                                        <td >
                                            <a href="/admin.php/Auth/group_editor/id/<?php echo ($v["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">编辑</button></a>
                                        </td>
