                    ...
                    <div class="widget-content nopadding">
                        <div class="over"  >
                            <table class="table table-bordered data-table" style="overflow:hidden">
                                ...
                                <tbody>
                                <?php if(is_array($info)): foreach($info as $k=>$v): if($v['p_id'] == 0): ?><tr class="gradeX">
                                            <td><?php echo ($k+1); ?></td>
                                            <td><?php echo ($v["title"]); ?></td>
                                            <td><?php echo ($v["name"]); ?></td>
                                            <?php if($v['is_visible'] == 1): ?><td><span style="color:red">显示</span></td>
                                                <?php else: ?>
                                                <td>隐藏</td><?php endif; ?>
                                            <td >
                                                <a href="/admin.php/Auth/rule_editor/id/<?php echo ($v["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">编辑</button></a>
                                            </td>
                                        </tr>
                                        <?php if(is_array($info)): foreach($info as $kk=>$vv): if($vv['p_id'] == $v['id']): ?><tr class="gradeX">
                                                    <td><?php echo ($k+1); ?>--<?php echo ($kk+1); ?></td>
                                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|--<?php echo ($vv["title"]); ?></td>
                                                    <td><?php echo ($vv["name"]); ?></td>
                                                    <?php if($vv['is_visible'] == 1): ?><td><span style="color:red">显示</span></td>
                                                        <?php else: ?>
                                                        <td>隐藏</td><?php endif; ?>
                                                    <td >
                                                        <a href="/admin.php/Auth/rule_editor/id/<?php echo ($vv["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">编辑</button></a>
                                                    </td>
