...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">员工管理</a> <a href="#" class="current">添加员工</a> </div>
        <h1>添加员工</h1>
    </div>
            ...
            <div class="span6">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/admin.php/Auth/editor_user_auth_do" method="post" class="form-horizontal" enctype="multipart/form-data" >

                            <div class="control-group">
                                <label class="control-label">用户名</label>
                                <div class="controls">
                                    <input type="text" class="span6" disabled value="<?php echo ($user["username"]); ?>" />
                                </div>
                            </div>
                            <!--传值添加用户管理表-->
                            <input type="hidden" name="uid" value="<?php echo ($user["id"]); ?>">
                            <div class="control-group ">
                                <label class="control-label span6">所属用户组</label>
                                <div class="controls">
                                    <select name="group_id">
                                        <option value="0">请选择</option>
                                        <?php if(is_array($group)): foreach($group as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if(($v["id"]) == $group_id["group_id"]): ?>selected<?php endif; ?> ><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
