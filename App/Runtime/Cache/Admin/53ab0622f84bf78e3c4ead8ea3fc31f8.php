        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="widget-box">
                    ...
                    <!--</div>-->
                    <form action="/admin.php/Auth/group_editor_do" method="post">
                        <div class="control-group" style="margin-left: 20px;margin-top: 20px;">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="span3" name="title" value="<?php echo ($group["title"]); ?>"/>
                            </div>
                        </div>
                            ...
                            <table style="line-height: 40px">
                                ...
                                <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                                        <?php if($v['p_id'] == 0): ?><td><input type="checkbox" class="xunz_box" data-id="<?php echo ($k); ?>" data-select="0"/><?php echo ($v["title"]); ?>：&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;</td>
                                            <?php if(is_array($info)): foreach($info as $key=>$vv): if($vv['p_id'] == $v['id']): ?><td><input type="checkbox"  class="input_box" data-id="<?php echo ($k); ?>" name="rules[]" value="<?php echo ($vv["id"]); ?>"
                                                        <?php if (in_array($vv['id'],$str)){ echo " checked "; } ?>
                                                    /><?php echo ($vv["title"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><?php endif; endforeach; endif; endif; ?>
