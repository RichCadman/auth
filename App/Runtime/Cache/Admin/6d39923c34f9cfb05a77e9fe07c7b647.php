...
<head>
    ...
    <link rel="stylesheet" href="/Pub/admin/css/matrix-login.css" />
...
<body>
<div id="loginbox">
    <form id="loginform" class="form-vertical" action="/admin.php/Login/login_do" method="post">
        <div class="control-group normal_text"> <h3><img src="/Pub/admin/img/logo.png" alt="Logo" /></h3></div>
        ...
        <div class="form-actions">
            ...
            <!--<span class="pull-right"><a type="submit" hrwork_index.htmlhtml" class="btn btn-success" /> Login</a></span>-->
...
<script src="/Pub/admin/js/matrix.login.js"></script>
</body>
