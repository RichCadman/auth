    ...
    <script>
        KindEditor.ready(function(K) {
            var editor1 = K.create('textarea[name="describe"]', {
                ...
                uploadJson: '__KIND__/php/upload_json.php',
                fileManagerJson: '__KIND__/php/file_manager_json.php',
...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">规则管理</a> <a href="#" class="current">修改规则</a> </div>
        <h1>修改规则</h1>
    </div>
            ...
            <div class="span6">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/admin.php/Auth/rule_editor_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
                            <!--隐藏域-->
                            <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                            <div class="control-group">
                                <label class="control-label">规则名称</label>
                                <div class="controls">
                                    <input type="text" class="span6" name="title" value="<?php echo ($info["title"]); ?>" />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6" name="name" value="<?php echo ($info["name"]); ?>" />
                                </div>
                            </div>
                            ...
                            <div class="control-group ">
                                ...
                                <div class="controls">
                                    <select name="p_id">
                                        <option value="0" <?php if(($ling) == $info["p_id"]): ?>selected<?php endif; ?> >--顶级规则--</option>
                                        <?php if(is_array($rule)): foreach($rule as $key=>$v): if($v['p_id'] == 0): ?><option value="<?php echo ($v["id"]); ?>"  <?php if(($v["id"]) == $info["p_id"]): ?>selected<?php endif; ?> >&nbsp;&nbsp;|--<?php echo ($v["title"]); ?></option>
                                                <?php if(is_array($rule)): foreach($rule as $key=>$vv): if($vv['p_id'] == $v['id']): ?><option value="<?php echo ($vv["id"]); ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|--<?php echo ($vv["title"]); ?></option><?php endif; endforeach; endif; endif; endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6" name="nav" value="<?php echo ($info["nav"]); ?>" />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label>
                                        <input type="radio" name="is_visible"  value="1"  <?php if(($yi) == $info["is_visible"]): ?>checked<?php endif; ?> />
                                        显示</label>
                                    <label>
                                        <input type="radio" name="is_visible" value="2"  <?php if(($er) == $info["is_visible"]): ?>checked<?php endif; ?> />
                                        隐藏</label>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6" name="icon"  value="<?php echo ($info["icon"]); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6" name="controller"  value="<?php echo ($info["controller"]); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6" name="function" value="<?php echo ($info["function"]); ?>" />
                                </div>
                            </div>
