...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">用户管理</a><a href="#" class="current">员工总览</a> </div>
        <h1 style="float:left">用户总览</h1><a href="/admin.php/User/add_user" class="btn btn-large btn-success" style="float:right;margin-top:30px;margin-right:15px">添加用户</a>
    </div>
                        ...
                        <div class="over"  >
                            <table class="table table-bordered data-table" style="overflow:hidden">
                                ...
                                <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr class="gradeX">
                                        ...
                                        <td >
                                            <a href="/admin.php/Users/users_editor/id/<?php echo ($v["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">编辑</button></a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="/admin.php/Auth/editor_user_auth/id/<?php echo ($v["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">管理权限</button></a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <button onclick="del(this,<?php echo ($v["id"]); ?>)" class='btn btn-danger'>回收站</button>
                                            </if>
                                        </td>
